...
export const externalDataApi = {
  syncJobs: () => api.post('/external-data/jobs/sync'),
  syncCodeforces: (tag, limit) => api.post('/external-data/codeforces/sync', null, { params: { tag, limit } }),
  runs: (params) => api.get('/external-data/runs', { params })
}
