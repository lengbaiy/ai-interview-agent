...
@router.post(
    "/{interview_id}/answer",
    dependencies=[Depends(rate_limit("interview-answer", limit=30, window_seconds=60))],
)
...
@router.post(
    ...
    dependencies=[Depends(rate_limit("interview-answer-stream", limit=20, window_seconds=60))],
)
