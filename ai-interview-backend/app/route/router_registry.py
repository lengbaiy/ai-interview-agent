...
CLIENT_ROUTES = [
    ...
    RouteConfig(
        module_path="app.api.client.v1.jobs",
...
BACKOFFICE_ROUTES = [
    ...
    RouteConfig(
        module_path="app.api.backoffice.v1.external_data",
        prefix=f"{settings.API_V1_STR}/backoffice/external-data",
        tags=["backoffice-external-data"]
    ),
]
