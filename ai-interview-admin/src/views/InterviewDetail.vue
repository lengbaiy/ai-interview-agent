    ...
    <template v-else-if="detail">
      ...
      <div class="card" style="margin-bottom:16px">
        <div class="info-grid">
          ...
          <div><span class="info-label">综合得分</span><span style="font-weight:700;color:var(--color-primary)">{{ detail.overall_score || '-' }}</span></div>
...
.msg.candidate { background: var(--color-primary-soft); }
.msg-role { font-size: 12px; font-weight: 600; color: #6b7280; margin-bottom: 6px; }
.msg-content { font-size: 14px; line-height: 1.7; }
.msg-score { margin-top: 8px; font-size: 12px; color: var(--color-primary); font-weight: 500; }
</style>
