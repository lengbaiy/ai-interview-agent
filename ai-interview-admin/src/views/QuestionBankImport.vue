...
.hint { background: var(--color-primary-soft); color: var(--color-primary); padding: 12px 16px; border-radius: 6px; margin-bottom: 16px; font-size: 13px; line-height: 1.7; border: 1px solid rgba(5, 150, 105, 0.14); }
...
.form-item textarea:focus { border-color: var(--color-primary); box-shadow: 0 0 0 3px var(--color-focus); outline: none; }
